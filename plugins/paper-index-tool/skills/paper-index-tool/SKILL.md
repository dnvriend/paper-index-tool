...
**Usage:**
```bash
paper-index-tool command-name ARGUMENT [OPTIONS]
```
...
```bash
# Example 1: Basic usage
paper-index-tool command-name "example"

# Example 2: With options
paper-index-tool command-name "example" --option value

# Example 3: Pipeline usage
paper-index-tool command-name "example" --json | jq '.'
```
...
- **GitHub**: https://github.com/dnvriend/paper-index-tool
- **Python Package Index**: https://pypi.org/project/paper-index-tool/
