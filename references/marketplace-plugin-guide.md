...
- **Slash Commands**: Quick CLI invocations (e.g., `/paper-index-tool:help`)
- **Skills**: Comprehensive documentation with progressive disclosure (e.g., `/skill-paper-index-tool`)
...
**File**: `plugins/paper-index-tool/.claude-plugin/plugin.json`
...
**Location**: `plugins/paper-index-tool/commands/`
...
**Adding New Commands**:
1. Create `plugins/paper-index-tool/commands/<command>.md`
...
/paper-index-tool:command "argument"
```

## Skills

**Location**: `plugins/paper-index-tool/skills/paper-index-tool/SKILL.md`
...
Or:
```
Use the skill-paper-index-tool to help me understand this tool
```
...
1. **Update the slash command** (optional):
   - Create `plugins/paper-index-tool/commands/<command>.md`
...
3. `plugins/paper-index-tool/.claude-plugin/plugin.json` → `version`
...
# Check plugin
cat plugins/paper-index-tool/.claude-plugin/plugin.json | jq '.'

# List commands
ls plugins/paper-index-tool/commands/

# Check skill
cat plugins/paper-index-tool/skills/paper-index-tool/SKILL.md
```

### Test in Claude Code
1. Open your project in Claude Code
2. Try slash command: `/paper-index-tool:help`
3. Try skill: `/skill-paper-index-tool`
